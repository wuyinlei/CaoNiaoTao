...
/**
 * Created by wuyinlei on 2017/9/26.
 */

public class CNApplication extends Application {


    public static CNApplication application = null;
    ...
    public void onCreate() {
        ...
        AlibcTradeSDK.asyncInit(this, new AlibcTradeInitCallback() {
            ...
            public void onSuccess() {
                Toast.makeText(CNApplication.this, "初始化成功", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int code, String msg) {
                Toast.makeText(CNApplication.this, "初始化失败,错误码="+code+" / 错误消息="+msg, Toast.LENGTH_SHORT).show();
            }
        });
